    ...
    const handleConfirm = () => {
        ...
        if (quantity === 0) {
            toast({
                ...
                description:
                    "Quantity cannot be zero. Please enter a positive or negative number.",
                variant: "destructive",
            });
            return;
        }
        if (!productName || productName === "Unknown Product") {
            toast({
                title: "This Product Is Not Found In Inventory",
                description: "Please enter a valid product SKU",
                variant: "destructive",
            });
            return;
        }
        ...
        <div className="bg-card rounded-lg border p-4 space-y-4">
            ...
            <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">{productName}</div>
                </div>
